...
const ReviewsSectn = () => {
  return (
    <>
      <div className="flex justify-between flex-wrap sm:flex-row flex-col border-2 border-black text-center gap-16 sm:px-16 px-4 py-10 bg-[#f1f5ff]">
        <div className="border-2 border-black flex flex-col items-center justify-center space-y-4 w-[100%] ">
        ...
        <div className="border-2 border-black flex flex-col flex-1 items-center justify-center space-y-4">
